...
def process_inputs(audio_filepath, image_filepath):
    # Create absolute path for the output audio file
    output_audio_path = os.path.abspath("final.mp3")
    ...
    # Generate the audio response and get the WAV file path
    wav_filepath = text_to_speech_with_elevenlabs(input_text=doctor_response, output_filepath=output_audio_path)
    print(f"Generated WAV file at: {wav_filepath}")
    ...
    return speech_to_text_output, doctor_response, wav_filepath
